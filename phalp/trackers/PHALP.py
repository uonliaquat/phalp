...
class PHALP(nn.Module):
    ...
    def cached_download_from_drive(self, additional_urls=None):
        ...
        if not os.path.exists(smpl_path):
            ...
            os.system('wget https://huggingface.co/spaces/brjathu/HMR2.0/resolve/e5201da358ccbc04f4a5c4450a302fcb9de571dd/data/smpl/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl')
